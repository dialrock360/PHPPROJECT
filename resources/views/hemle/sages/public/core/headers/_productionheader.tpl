...
<head>
    ...
    <link href="{$url_base}public/assets/vendor/fontawesome-free/css/fontawesome.css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="{$url_base}public/assets/plugins/jQuery-File-Upload-master/css/jquery.fileupload.css" />
    <link rel="stylesheet" href="{$url_base}public/assets/plugins/jQuery-File-Upload-master/css/jquery.fileupload-ui.css" />
    <!-- CSS adjustments for browsers with JavaScript disabled -->
    <noscript
    ><link rel="stylesheet" href="{$url_base}public/assets/plugins/jQuery-File-Upload-master/css/jquery.fileupload-noscript.css"
        /></noscript>
    <noscript
    ><link rel="stylesheet" href="{$url_base}public/assets/plugins/jQuery-File-Upload-master/css/jquery.fileupload-ui-noscript.css"
        /></noscript>
